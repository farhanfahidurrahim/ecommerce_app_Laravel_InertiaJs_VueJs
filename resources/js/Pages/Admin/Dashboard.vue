        ...
        <div class="row">
          <div class="col-md-4 stretch-card grid-margin">
            <div class="card bg-gradient-danger card-img-holder text-white">
              <div class="card-body">
                <img
                  src="/admin_assets/images/dashboard/circle.svg"
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <img
                            src="/admin_assets/images/faces/face1.jpg"
                            class="me-2"
                            alt="image"
                          />
                          David Grey
                      ...
                      <tr>
                        <td>
                          <img
                            src="/admin_assets/images/faces/face2.jpg"
                            class="me-2"
                            alt="image"
                          />
                          Stella Johnson
                      ...
                      <tr>
                        <td>
                          <img
                            src="/admin_assets/images/faces/face3.jpg"
                            class="me-2"
                            alt="image"
                          />
                          Marina Michel
                      ...
                      <tr>
                        <td>
                          <img
                            src="/admin_assets/images/faces/face4.jpg"
                            class="me-2"
                            alt="image"
                          />
                          John Doe
              ...
              <div class="card-body">
                ...
                <div class="row mt-3">
                  <div class="col-6 pe-1">
                    <img
                      src="/admin_assets/images/dashboard/img_1.jpg"
                      class="mb-2 mw-100 w-100 rounded"
                      alt="image"
                    />
                    <img
                      src="/admin_assets/images/dashboard/img_4.jpg"
                  ...
                  <div class="col-6 ps-1">
                    <img
                      src="/admin_assets/images/dashboard/img_2.jpg"
                      class="mb-2 mw-100 w-100 rounded"
                      alt="image"
                    />
                    <img
                      src="/admin_assets/images/dashboard/img_3.jpg"
                      class="mw-100 w-100 rounded"
                      alt="image"
                    />
                  </div>
